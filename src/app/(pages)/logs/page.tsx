    ...
    const columnas: ITableColumn<ILog>[] = [
        {
            ...
            cell: (row: ILog) => row.full_name_user,
            selector: (row: ILog) => row.full_name_user,
            sortable: true
        },
        {
        ...
        },
        {
            ...
            cell: (row: ILog) => row.email_assignment_contact,
            selector: (row: ILog) => row.email_assignment_contact,
            sortable: true
        },
        {
            name: 'Fecha Asignación',
            cell: (row: ILog) => row.assignment_date_contact,
            selector: (row: ILog) => row.assignment_date_contact,
            sortable: true
        }
    ]
